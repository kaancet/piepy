...
class WheelBehaviorPlotter(WheelBasePlotter):
    ...
    def pool_data(self):
        ...
        for row in data.to_dict(orient="records"):
            ...
            self.big_df = pd.concat(
                [self.big_df, sesh_data_df], ignore_index=True, sort=False
            )

        self.big_df = get_running_stats(
            self.big_df, stats=running_stats, window_size=100, copy_data=False
        )
    ...
    def performance(self, plt_mode="discrete", ax=None, *args, **kwargs):
        ...
        if plt_mode == "discrete":
            ...
            tick_space = 500
            ax.plot(
                self.big_df["total_trial_no"],
                100 * self.big_df["fraction_correct"],
                color="darkgreen",
    ...
    def responseTimes(self, plt_mode="discrete", ax=None, *args, **kwargs):
        ...
        if plt_mode == "discrete":
            ...
            ax.plot(
                self.big_df["total_trial_no"],
                self.big_df["running_response_latency"] / 1000,
                color="royalblue",
                linewidth=kwargs.get("linewidth", 5),
    ...
    def psychometric(self, pool_depth=5, ax=None, *args, **kwargs):
        ...
        for key in tmp_dict.keys():
            ...
            ax.errorbar(
                100 * curve.contrast_x,
                curve.proportion_right,
                curve.binomial_right,
            ...
            ax.plot(
                100 * curve.contrast_x_fitted,
                curve.proportion_right_fitted,
                c=area_colors[key],
